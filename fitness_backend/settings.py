...
SECRET_KEY = "django-insecure-n%hi$dzm-^r^riq0wa(0u-y3@cil^#v+l52mlfzs$vz5*m6_!i"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # or specifically '192.168.31.36'
...
# Optional: If you want more specific CORS settings, you can use these instead:
